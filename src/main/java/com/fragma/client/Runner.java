...
public class Runner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
           ...
           reportDao.getBahrainCIFlevelCount(mainDto);
           reportDao.getBahrainAccountlevelCount(mainDto);
           reportDao.getKuwaitCIFlevelCount(mainDto);
           reportDao.getKuwaitAccountlevelCount(mainDto);
           reportDao.getQatarCIFlevelCount(mainDto);
           reportDao.getQatarAccountlevelCount(mainDto);
           reportDao.getUAECIFlevelCount(mainDto);
           reportDao.getUAEAccountlevelCount(mainDto);

           reportDao.getExcelDataForBahrain(mainDto);
           reportDao.getExcelDataForKuwait(mainDto);
           reportDao.getExcelDataForQatar(mainDto);
           reportDao.getExcelDataForUAE(mainDto);
          ...
          //  LOG.info("Excel File Location:"+ ConfigurationHelper.getExcelLocation());
            ...
            excelFileCreator.createExcelSheetForBahrain(ConfigurationHelper.getExcelLocationForBahrain(),mainDto);
            excelFileCreator.createExcelSheetForKuwait(ConfigurationHelper.getExcelLocationForKuwait(),mainDto);
            excelFileCreator.createExcelSheetForQatar(ConfigurationHelper.getExcelLocationForQatar(),mainDto);
            excelFileCreator.createExcelSheetForUAE(ConfigurationHelper.getExcelLocationForUAE(),mainDto);

            context.setVariable("mainDto", mainDto);

          templateEngine.process("report", context, writer);

        // sendMailWithAttachment(writer.toString(),mainDto);
    ...
    public void sendMailWithAttachment(String body, MainDto mainDto) {
        ...
        try {
            ...
            String subject=smtpMailThreadConfig.getSubject();
            StringBuilder subject1 = new StringBuilder(subject + mainDto.subDate());

            LOG.info("******subject  for mail :"+subject1);

            msg.setSubject(subject1.toString(), "UTF-8");
          ...
          //  LOG.info("Excel Location ->"+configurationHelper.getExcelLocation());
            ...
            addAttachment(multipart, ConfigurationHelper.getExcelLocationForBahrain());
            addAttachment(multipart, ConfigurationHelper.getExcelLocationForKuwait());
            addAttachment(multipart, ConfigurationHelper.getExcelLocationForQatar());
            addAttachment(multipart, ConfigurationHelper.getExcelLocationForUAE());
